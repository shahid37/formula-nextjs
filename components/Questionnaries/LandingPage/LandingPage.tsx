  ...
  return (
    <div className="flex relative">
      <Image
        ...
        alt="side image"
      />
      <div className="absolute xs:left-4 md:left-28 bottom-28 xs:top-20 md:top-80 flex flex-col xs:justify-end text-white">
        <h1 className="xs:w-auto md:w-2/5 xs:text-[44px] xs:leading-[50px] md:text-[64px] md:leading-[64px]">
          {text}
        </h1>
        <h5 className="mt-6 xs:w-60 md:w-1/5">
          Answer the following questions as best as you can.
        </h5>
        <div className="mt-20 xs:w-60 md:w-80 pb-4">
